...
const WriteArticle = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            setLoading(true)
            const prompt = `Write a detailed and comprehensive article on the topic: ${input}. The article should be around ${selectedLength.text} words.`
    ...
    return (
        <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
            ...
            <form onSubmit={onSubmitHandler} className="w-full max-w-lg p-6 bg-white rounded-lg border border-gray-200 space-y-6">
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700">Article Length</label>
            ...
            <div className="w-full max-w-lg mt-6">
                ...
                {!content ? (
                    ...
                    <div classNmae='mt-3 h-full overflow-y-scroll text-sm text-slate-600'>
                        <div>{content}</div>
                    </div>
                )}
